...
notebooks_to_run = ["ca-counties.ipynb", "us-counties.ipynb", "la-neighborhoods.ipynb"]
output_path = ["./ca-county-trends.ipynb", "./us-county-trends.ipynb", "./la-neighborhoods-trends.ipynb"]
